        ...
        <td bgcolor="#FFFFFF">
            <form id="myform2" name="myform2" method="get" action="" onsubmit="return checkpost2();">
                <div id="InputsWrapper1">
                    <div>
                        <input name="zhifu[]" id="zhifu" type="text" value="2" style="display:none;" />
                        <font color="red">金额：</font><input type="text" name="money[]" id="money" value="" style="width:70px;" />
                        <font color="red"> 分类：</font><select name="classid[]" style="height:26px;"><?php
                                                                                                    $sql = "select * from " . $prename . "account_class where classtype=2 and ufid='$_SESSION[uid]'";
                                                                                                    $query = mysqli_query($conn, $sql);
                                                                                                    while ($acclass = mysqli_fetch_array($query)) {
                                                                                                        echo "<option value='$acclass[classid]'>$acclass[classname]</option>";
                                                                                                    ...
                                                                                                    ?></select>
                        <font color="red"> 备注：</font><input name="remark[]" type="text" style="width:120px;" /> 时间：<input type="text" name="time[]" value="<?php echo date("Y-m-d H:i");
                    ...
                    <input name="Submit" type="submit" id="Submit" value="记账" class="btn btn-default" />
                    <font color="#ccc">空数据自动跳过！</font>
            </form>
        </td>
    </tr>
    <tr>
        ...
        <td bgcolor="#FFFFFF">
            <form id="myform1" name="myform1" method="get" action="" onsubmit="return checkpost();">
                <div id="InputsWrapper">
                    <div>
                        <input name="zhifu[]" id="zhifu" type="text" value="1" style="display:none;" />
                        <font color="MediumSeaGreen">金额：</font><input type="text" name="money[]" id="money" value="" style="width:70px;" />
                        <font color="MediumSeaGreen"> 分类：</font><select name="classid[]" style="height:26px;"><?php
                                                                                                                $sql = "select * from " . $prename . "account_class where classtype=1 and ufid='$_SESSION[uid]'";
                                                                                                                $query = mysqli_query($conn, $sql);
                                                                                                                while ($acclass = mysqli_fetch_array($query)) {
                                                                                                                    echo "<option value='$acclass[classid]'>$acclass[classname]</option>";
                                                                                                                ...
                                                                                                                ?></select>
                        <font color="MediumSeaGreen"> 备注：</font><input name="remark[]" type="text" style="width:120px;" /> 时间：<input type="text" name="time[]" value="<?php echo date("Y-m-d H:i");
