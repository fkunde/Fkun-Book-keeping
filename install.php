    ...
    <p align="center">
        ...
        if (indatabase($db_dbname,$conn)) {
            ...
            if ($query) {
                ...
                echo "失败<br /><font color='red'>安装完毕</font></body></html>";

            }
        }
        echo "创建表 <br />".$prename."account .....";
        ...
        if ($attitle) {
            ...
            $sql = "insert into ".$prename."date (date,ufid,datetype) values ('1609455600','1','0'),('30','1',1)";
            $query = mysqli_query($conn,$sql);
            echo "创建成功！<br />";
        }
