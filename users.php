    ...
    <tr>
        <td bgcolor="#FFFFFF">
            ...
            <form action="" method="post" name="submitxiugai">
                ...
                <?php $sqlzhanghu = "SELECT * FROM ".$prename."user where uid='$_SESSION[uid]'";
                ...
                if ($_POST['Submitxiugai']) {
                    ...
                    if ($jiumima == $row['password'] && $_POST['password']<>$_POST['jiupassword']) {
                        ...
                        $sql = "update ".$prename."user set password='$umima',cpassword='$_POST[cpassword]',email='$_POST[email]' where uid='$_SESSION[uid]'";
